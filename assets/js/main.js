...
var formSubmit = document.getElementById('form__send')
formSubmit.addEventListener('click', function (e){
    ...
    Email.send({
        ...
        To : 'pilgrimarcheon@gmail.com',
        From : 'shontandaniel@gmail.com',
        Subject : "Project From: " + document.getElementById('form__name').value,
        Body : messageBody
    }).then(
